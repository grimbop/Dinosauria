...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> ARAUCARIA_STRIPPED_LOG = register("araucaria_stripped_log", () -> new RotatedPillarBlock(AbstractBlock.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> ARAUCARIA_DOOR = register("araucaria_door", () -> new DoorBlock(AbstractBlock.Properties.from(Blocks.ACACIA_DOOR)));
    public static final RegistryObject<Block> ARAUCARIA_PLANKS = register("araucaria_planks", () -> new Block(AbstractBlock.Properties.from(Blocks.OAK_PLANKS)));
